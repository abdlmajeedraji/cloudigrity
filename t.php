...
<body>
  ...
  <script type="text/javascript"> //AES ENCRYPTION AFTER MERGING ENTERED DETAILS
    ...
    var hash = CryptoJS.SHA3(formString,{outputLenght :512});
    window.location.href = "http://localhost:8080/cloudigrity/login1.php?hash="+hash+"&formString="+formString;
