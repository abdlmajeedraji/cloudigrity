...
-----END PUBLIC KEY-----</textarea><br/>
    ...
    <textarea id="input" name="input" type="text" rows=4 cols=70>Thnnnnnnnnnnnnnnnis is a test!</textarea><br/>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#testme').click(function () {
      ...
      var encrypted = encrypt.encrypt($(data).val());
      ...
      if (uncrypted == $(data).val()) {
        alert('It worksiiiiiiiiiiiiiiiiiiiiiiiii!!!');
      }
      else {
        alert('Something went wnnnnnnnnnnnnnnnnnnnnnnnrong....');
      }
    });
  });
</script>